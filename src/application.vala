...
namespace Multiclock {
    public class Application : Adw.Application {
        ...
        public Application () {
            Object (application_id: "io.github.r_sergii.multiClock", flags: ApplicationFlags.FLAGS_NONE);
        }
...
//            stdout.printf ("%s\n", info.os + "-" + info.cpu);
        ...
        public override void activate () {
            ...
            provider.load_from_resource ("/io/github/r_sergii/multiClock/theme_switcher.css");
      ...
      //                             "authors", authors,
        //                           "version", "0.1.1");
            ...
            var win = new Adw.AboutWindow () {
                ...
                application_icon = "io.github.r_sergii.multiClock",
                version = "0.1.1",
